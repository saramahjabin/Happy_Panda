...
<main>
    ...
    <header id="site-header">
        <div class="container">
            <h1>Order Conformation  <span>[</span> <em>by Happy-Panda</em> <span class="last-span is-open">]</span></h1>
        ...
        <section id="cart">
                ...
                <article class="product">
                    ...
                    <div class="content">
                        ...
                        Total Price: <c:forEach items="${cart}" var="c"> ${c.price} +
                            </c:forEach><br>
                    ...
                    <div class="content">
                        <form method="post" action="OrderProcess">
                            ...
                            <label for="OnlinePayment">Online Payment</label><br></p>
                        </div>
                            <p><b>Delivery Address:</b>
                            <input type="text" id="address" name="address"/></p>
                            <input type="hidden" id="description" name="description" value="<c:forEach items="${cart}" var="c">${c.name}, </c:forEach>">
                            <input type="hidden" id="totalprice" name="totalprice" value="<c:forEach items="${cart}" var="c"> ${c.price} + </c:forEach>60 Tk">
